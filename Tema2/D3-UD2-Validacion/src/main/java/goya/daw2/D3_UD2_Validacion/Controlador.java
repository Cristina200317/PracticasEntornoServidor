package goya.daw2.D3_UD2_Validacion;
...
public class Controlador {
	...
	@GetMapping("/url3")
	public String url3(@RequestParam("nombre") String nombre, @RequestParam("opcion") String opcion, Model model) {
	...
	@GetMapping("/url4")
	public String url4(@RequestParam("nombre") String nombre, @RequestParam("opcion") String opcion,
			@RequestParam(value = "opciones", required = false) List<String> opciones,
			@RequestParam("rangoEdad") String rangoEdad, Model model) {
	...
	@GetMapping("/url5")
	public String url5(@RequestParam("nombre") String nombre, @RequestParam("opcion") String opcion,
			@RequestParam(value = "opciones", required = false) List<String> opciones,
			@RequestParam("rangoEdad") String rangoEdad, Model model) {
